...
IndexSegment.prototype.modifySegmentValues = function(newSegmentData, initialConditions) {
	...
	this.segmentData.velLimNeg = (newSegmentData.velLimNeg || newSegmentData.velLimNeg == 0) ? newSegmentData.velLimNeg : this.segmentData.velLimNeg;
	this.segmentData.velLimPos = (newSegmentData.velLimPos || newSegmentData.velLimPos == 0) ? newSegmentData.velLimPos : this.segmentData.velLimPos;
