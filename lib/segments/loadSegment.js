 ...
 */
var LoadSegment = function(type, t0, tf, initVal, finalVal, constant) {
...
LoadSegment.prototype.importFromData = function(data) {
	return new LoadSegment(data.loadType, data.initialType, data.finalTime, data.initialValue, data.finalValue, data.constant);
};


LoadSegment.prototype.modifySegmentValues = function (newSegmentData) {
	this.segmentData.initialTime = (newSegmentData.initialTime || newSegmentData.initialTime === 0) ? newSegmentData.initialTime : this.segmentData.initialTime;
	this.segmentData.finalTime = (newSegmentData.finalTime) ? newSegmentData.finalTime : this.segmentData.finalTime;
	this.segmentData.initialValue = (newSegmentData.initialValue || newSegmentData.initialValue === 0) ? newSegmentData.initialValue : this.segmentData.initialValue;
	this.segmentData.finalValue = (newSegmentData.finalValue || newSegmentData.finalValue === 0) ? newSegmentData.finalValue : this.segmentData.finalValue;
	this.segmentData.loadType = (newSegmentData.loadType) ? newSegmentData.loadType : this.segmentData.loadType;
	this.segmentData.constant = (newSegmentData.constant !== null) ? newSegmentData.constant : this.segmentData.constant;
