...
AccelSegmentTimeVelocity.prototype.modifySegmentValues = function(newSegmentData, initialConditions) {
	...
	if (this.segmentData.mode == 'incremental') {
		this.segmentData.speed = (newSegmentData.speed || newSegmentData.speed === 0) ? newSegmentData.speed : this.segmentData.speed;
		...
		this.segmentData.finalVelocity = initialConditions.velocity + this.segmentData.speed;
		...
		this.segmentData.speed = this.segmentData.finalVelocity - initialConditions.velocity;
