...
/**
 * Creates basic segments from previously calculated array of coefficients
 * @param  {Array} coefficients Array of array of coefficients in form of [A,B,C,D] (Ax^3+Bx^2+Cx+D)
 * @param {Array} times array of times gathered from user input
 * @return {array}              array of newcly created basic segments
 */
CamMotionSegment.prototype.createBasicSegmentsFromCoefficients = function(coefficients, times) {
