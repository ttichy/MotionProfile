...
CamMotionSegment.prototype.duplicate = function () {
    var camSeg = new CamMotionSegment(
        this.segmentData.master[0],
        this.segmentData.slave[0],
        this.segmentData.initialSlope,
        this.segmentData.loads
    );
    var camTable = new CamSegment.CamTable();
    camTable.master = this.segmentData.master;
    camTable.slave = this.segmentData.master;
    camTable.interpolation = this.segmentData.interpolation;
    camTable.initialSlope = this.segmentData.initialSlope;
    camTable.finalSlope = this.segmentData.finalSlope;
