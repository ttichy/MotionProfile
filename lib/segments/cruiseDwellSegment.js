...
CruiseDwellMotionSegment.prototype.modifySegmentValues = function(newSegmentData, initialConditions) {
	...
	this.segmentData.permutation = (newSegmentData.permutation || newSegmentData.permutation == 0) ? newSegmentData.permutation : this.segmentData.permutation;
	this.segmentData.mode = (newSegmentData.mode || newSegmentData.mode == 0) ? newSegmentData.mode : this.segmentData.mode;
