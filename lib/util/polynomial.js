...
Polynomial.prototype.getExtremeValues = function () {
    ...
    var x = x.filter(function (r) {
        return typeof r == 'number' && !isNaN(r) && isFinite(r) && FastMath.gt(r, this.startpoint) && FastMath.lt(r,this.endpoint);
    });

    // x = [].concat(y, this.startPoint, this.endPoint);
    x = _.without([].concat(y, this.startPoint, this.endPoint), undefined);
