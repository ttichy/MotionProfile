...
it('should be able create a profile with three segments, delete one, undo and get back to the original profile', function() {
    ...
    it('should be able create a profile with an accel segment, a cruise segment and then modify the accel segment', function() {
        ...
        profile.modifySegmentValues(seg1.id,{
            ...
            position: seg1.evaluatePositionAt(2),
            velocity: seg1.evaluateVelocityAt(2)
        });
