describe('Unit: cruise/dwell segment testing', function() {
    ...
    it('should create an cruise dwell segment with via distance (t0=0,tf=2,p0=0,v0=50,pf=25) and correctly evalute position and velocities', function() {
    ...
    it('should create an cruise dwell segment with via distance (t0=0,tf=2,p0=0,v0=0,pf=25) and correctly evalute position and velocities', function() {
    ...
    it('should create a cruise segment via zero distance and starting with v0=0 (t0=0,tf=2,p0=0,v0=0,pf=0', function() {
        ...
        var seg = cruiseSegmentFactory.make(0,0.5,0,0,0,'distance','incremental');
    ...
    expect(function() {cruiseSegmentFactory.make(0,0.5,0,0,5,'distance','incremental');})
        .toThrow(new Error("Unable to create a cruise/dwell segment with zero initial velocity and non zero distance"));
